...
```{tex}
De acuerdo a los resultados obtenidos puede evidenciar una tabla descriptiva en la cual se puede apreciar valores de desviacion estandar, la moda, la media. Ademas, de que esta organizado por categorias  en base a los niveles de expresion de genes. 
...
```{tex}
En el boxplot3 se puede evidenciar todos los datos de df en donde cada gen esta distribuido por los cuartiles, la cual los datos de genes de GATA 3 poseen valores mas equilibrados que los demas tipos de genes, ya que su valor de 0.7 esta proximadamente cerca del 0. Ademas se puede analizar que no existen valores atipicos. 

Mientras que en la regresion11 se puede apreciar la dispercion de los genes de GATA3 y FN1, por lo que cada unos de los puntos hace referencia a las concetracion de canceres que se aproducido por estos 2 tipos de genes. 
